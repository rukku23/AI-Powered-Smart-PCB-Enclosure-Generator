// EnclosureAI — Wearable Rounded: Lower Shell Module
// Bottom half of a wearable enclosure with rounded corners and edges.
// Uses minkowski() for smooth rounding.
//
// Parameters:
...
module wearable_lower_shell(outer_length, outer_width, half_height, wall,
                             corner_radius, edge_fillet) {
    $fn = 30;
    
    // Effective dimensions after minkowski offset
    ...
    difference() {
        ...
        minkowski() {
            translate([inner_radius, inner_radius, 0])
                cube([inner_length, inner_width, half_height]);
